...
/******************************************************************************** 
	...
	Assertion:
	There is one and only one CTV3 simple map refset members per concept.
...
********************************************************************************/
	...
	select 
		...
		'<ASSERTIONTEXT>',
<<<<<<< .mine
		concat('Concept: id=',b.id, ': Concept has more than one associated CTV3 refset member.') 
=======
		concat('CONCEPT: id=',b.id, ': Concept has more than one associated CTV3 refset member.') 
...
<<<<<<< .mine
	...
	where b.refsetid = '900000000000497000';
